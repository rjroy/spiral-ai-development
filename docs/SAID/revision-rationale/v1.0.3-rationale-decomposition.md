...
### User Experience Gap
The original SAID vision was to "develop a system to break down a problem into smaller and smaller components/features/concerns" using pre-defined developer prompts. However, the reality became "solve this thing: here's the thing" - too generic and lacking systematic decomposition.
